...
class Programmers extends Employee
{
 ...
 Programmers(String emp_name,int emp_id,String address,String mail_id,String mob_number,double bp)
 {  
 ...
 public static void main(String arg[])throws IOException
  {
    ...
    switch (desg)
    {
    case 1:Programmers p=new Programmers(name,id,add,mail,mob,bp);
           p.getPaySlip();
           p.disp();
           break;
    ...
    default:System.out.println("Invalid desugnation");
     }
   }
}
